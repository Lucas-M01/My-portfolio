...
//     <Dialog.Portal>
//       <Dialog.Overlay className="bg-black/60 opacity-50 z-10 inset-0 fixed" />
//       <Dialog.Content className="fixed bg-[#2A2634] flex flex-col md:grid md:grid-cols-2 w-[98%] lg:w-3/4 z-20 py-6 md:py-8 px-4 md:px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg max-h-[700px] shadow-lg shadow-black/25">
